...
import 'package:movie_tickets_booking/controllers/seat_selection_controller.dart';
import 'package:movie_tickets_booking/model/movie_model.dart';
import 'package:movie_tickets_booking/model/theatre_model.dart';
import 'package:movie_tickets_booking/utils/mytheme.dart';
import 'package:movie_tickets_booking/widgets/no_of_seats.dart';
import 'package:movie_tickets_booking/widgets/seat_layout.dart';
import 'package:movie_tickets_booking/widgets/seat_type.dart';
import 'package:movie_tickets_booking/widgets/theatre_block.dart';
          ...
          onPressed: () {
            ...
            if (SeatSelectionController.instance.isSeatSelection.value) {
              if (SeatSelectionController.instance.seatPrice <= 0.0) {
                AuthController.instance.getErrorSnackBarNew("Vui lòng chọn ít nhất 1 ghế");
                return;
              }
              SeatSelectionController.instance.createOrder();
            } else {
              if (SeatSelectionController.instance.noOfSeats.value <= 0) {
                AuthController.instance.getErrorSnackBarNew("Vui lòng chọn số ghế");
                return;
              }
              toggle(true);
            }
